      ...
      <DefaultLayout>
        <main className="flex flex-col items-center h-screen mt-32">
          ...
          <div className="container mt-40">
            ...
            <div id="services" className="relative pt-20 pb-8 rounded-xl section md:pt-16 md:pb-0 bg-opacity-5 ">
			...
			c0,10.201,8.271,18.471,18.472,18.471c10.2,0,18.471-8.271,18.471-18.471V18.472C469.247,8.27,460.977,0,450.776,0z"/>
                  ...
                  >
                    ...
                    <div className="px-12 py-8 mb-12 transition duration-300 ease-in-out transform border-b border-gray-100 bg-gray-50 hover:-translate-y-2 rounded-3xl">
                      ...
                      <p className="text-gray-500">Discover harmonious aquatic living with our Fish Compatibility Tool, you can  evaluate and match the perfect pair or trio of fish for a thriving community</p>
                    </div>
                    {/* End service block */}
                  </div>
		...
		C212.989,137.332,208.241,137.217,205.241,140.071z"/>
                      ...
                      <p className="text-gray-500">Connect and actively engage with fellow enthusiasts—post, comment, like, and share valuable insights in our interactive aquarium forum</p>
                    </div>
                    {/* End service block */}
                  </div>
                  <div
			...
			C16.319,24.054,16.032,23.721,15.963,23.527z"/>
                      ...
                      <p className="text-gray-500">Create the perfect habitat with our Environment Recommendation—get tailored advice for your tank setup</p>
                    </div>
                    {/* End service block */}
                  </div>
                </div>
            ...
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  ...
                  Fish Search
                  Easily explore a wide range of fish species with our Fish Search feature. Get detailed information and advertisement suggestions to help you find the perfect fish for your aquarium setup.
                </p>
                <a href="#" className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1">
                  Explore Fish Search <span className="ml-2 text-3xl">&rarr;</span>
                </a>
              </div>
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img src="../../../public/Fish Search.jpeg" alt="Fish Search" className="w-3/4 max-w-md transition duration-500 ease-in-out transform shadow-2xl rounded-3xl hover:scale-110" />
              </div>
            </section>
          </div>
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Receive instant, expert advice on aquarium care through our interactive chatbot. Whether you're a beginner or an expert, get answers to all your queries and ensure the health of your aquatic pets.
                </p>
                <a href="#" className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1">
                  Explore Chatbot <span className="ml-2 text-3xl">&rarr;</span>
                </a>
              </div>
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img src="../../../public/Chatbot.jpeg" alt="Chatbot" className="w-3/4 max-w-md transition duration-500 ease-in-out transform shadow-2xl rounded-3xl hover:scale-110" />
              </div>
            </section>
          </div>
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Promote your aquarium-related products or services with our sleek advertising platform. Reach a passionate audience of aquarium enthusiasts and ensure your offerings stand out with high-quality, aesthetic presentations.
                </p>
                <a href="#" className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1">
                  Explore Advertising Platform <span className="ml-2 text-3xl">&rarr;</span>
                </a>
              </div>
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img src="../../../public/Advertismenbts.jpeg" alt="Advertising Platform" className="w-3/4 max-w-md transition duration-500 ease-in-out transform shadow-2xl rounded-3xl hover:scale-110" />
              </div>
            </section>
          </div>
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Our Fish Compatibility Tool helps you assess which species can live together harmoniously. Whether pairing or grouping, ensure a peaceful and thriving aquatic environment with just a few clicks.
                </p>
                <a href="#" className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1">
                  Explore Fish Compatibility Tool <span className="ml-2 text-3xl">&rarr;</span>
                </a>
              </div>
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img src="../../../public/Fish Compatibility Tool.jpeg" alt="Compatibility Tool" className="w-3/4 max-w-md transition duration-500 ease-in-out transform shadow-2xl rounded-3xl hover:scale-110" />
              </div>
            </section>
          </div>
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Engage with fellow aquarium enthusiasts in our dynamic forum. Share your experiences, ask questions, and connect with people who share your passion for aquatics.
                </p>
                <a href="#" className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1">
              ...
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img src="../../../public/Community Forum.jpeg" alt="Community Forum" className="w-3/4 max-w-md transition duration-500 ease-in-out transform shadow-2xl rounded-3xl hover:scale-110" />
              </div>
            </section>
          </div>
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Get personalized advice for your aquarium’s environment with our tailored recommendations. From water conditions to tank setup, ensure your fish have the ideal habitat for a healthy life.
                </p>
                <a href="#" className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1">
              ...
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img src="../../../public/Environmental Recomendation.jpeg" alt="Environmental Recommendations" className="w-3/4 max-w-md transition duration-500 ease-in-out transform shadow-2xl rounded-3xl hover:scale-110" />
              </div>
            </section>
          </div>
