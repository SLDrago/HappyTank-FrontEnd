...
import fishSearchimg from "../../images/Home/FishSearch.jpeg";
import chatbotimg from "../../images/Home/Chatbot.jpeg";
import advertisingPlatformimg from "../../images/Home/Advertisments.jpeg";
import fishCompatibilityToolimg from "../../images/Home/FishCompatibilityTool.jpeg";
import communityForumimg from "../../images/Home/CommunityForum.jpeg";
import environmentalRecommendationsimg from "../../images/Home/EnvironmentalRecomendation.jpeg";
import "../../css/font.css";
      ...
      <DefaultLayout>
        <main className="flex flex-col items-center h-screen mt-32">
          ...
          <div className="container mt-40">
            ...
            <div
              id="services"
              className="relative pt-20 pb-8 rounded-xl section md:pt-16 md:pb-0 bg-opacity-5 "
            >
              <div className="container px-4 mx-auto xl:max-w-6xl">
                ...
                <header className="mx-auto mb-12 text-center lg:px-20">
                  ...
                  <p className="pb-2 m-0 mx-auto text-xl font-light leading-relaxed text-black Polysans_slim">
                    Explore our features and see how it can transform your
                    experience.
                  </p>
                </header>
                {/* End heading */}
                ...
                <div className="flex flex-row flex-wrap -mx-4 text-center ">
                  ...
                  >
                    ...
                    <div className="px-12 py-8 mb-12 transition duration-300 ease-in-out transform border-b border-gray-100 bg-gray-50 hover:-translate-y-2 rounded-3xl">
                      ...
                      <p className="text-gray-500">
                        {" "}
                        Explore our comprehensive fish search feature to find
                        detailed information, advertisements suggestions, for
                        any fish you desire, all in one place.
                      </p>
                    </div>
                    {/* End service block */}
                  </div>
                  ...
                  >
                    ...
                    <div className="px-12 py-8 mb-12 transition duration-300 ease-in-out transform border-b border-gray-100 bg-gray-50 hover:-translate-y-2 rounded-3xl">
                      ...
                      <p className="text-gray-500">
                        Get instant answers and expert advice on all things
                        aquarium with our new chatbot—your go-to resource for
                      ...
                      <div className="inline-block mb-4 text-gray-900">
                        ...
                        >
                          <g>
                            <g>
                              <path
                                d="M263.213,465.658c-3.551,0-6.589-2.549-7.202-6.046l-10.522-59.871l-2.699-15.36h7.454c3.157,0,5.718-2.56,5.718-5.719
			...
			h22.545h46.549h1.595c7.141,0,12.93-5.789,12.93-12.931C276.143,471.447,270.354,465.658,263.213,465.658z"
                          ...
                          <g>
                            <g>
                              <path
                                d="M125.803,111.855l-32.967,11.39v14.682H61.893c-6.225,0-11.272,5.047-11.272,11.272v6.767H33.547
			...
			c0,6.226,5.047,11.273,11.272,11.273h30.943v14.681l32.967,11.391h27.991h74.725h26.097V111.855H125.803z"
                          ...
                          <g>
                            <g>
                              <path
                                d="M450.776,0c-10.201,0-18.472,8.27-18.472,18.472v0.458l-162.329,92.924v175.944l162.329,92.923v0.46
			c0,10.201,8.271,18.471,18.472,18.471c10.2,0,18.471-8.271,18.471-18.471V18.472C469.247,8.27,460.977,0,450.776,0z"
                      ...
                      <p className="text-gray-500">
                        Elevate your brand and captivate aquarium enthusiasts
                        with our advertising platform where quality, service,
                        integrity, and aesthetics come together.
                      </p>
                    </div>
                    {/* End service block */}
                  </div>
                  ...
                  >
                    ...
                    <div className="px-12 py-8 mb-12 transition duration-300 ease-in-out transform border-b border-gray-100 bg-gray-50 hover:-translate-y-2 rounded-3xl">
                      ...
                      <p className="text-gray-500">
                        Discover harmonious aquatic living with our Fish
                        Compatibility Tool, you can evaluate and match the
                        perfect pair or trio of fish for a thriving community
                      </p>
                    </div>
                    {/* End service block */}
                  </div>
		...
		c4.143,0,7.262-3.597,7.262-7.739v-27.22C164.988,52.327,158.976,42.048,149.763,36.21z"
                            />
                            <path
                              d="M81.988,124.539v-27.22c0-11.689-5.754-21.969-14.967-27.807c3.01-3.811,5-8.616,5-13.837
		...
		C79.384,131.976,81.988,128.682,81.988,124.539z"
                            />
                            <path
                              d="M232.034,69.513c3.008-3.811,5.006-8.616,5.006-13.837c0-12.337-9.939-22.373-22.276-22.373
		...
		c0,4.143,3.326,7.437,7.469,7.437h50.811c4.143,0,6.721-3.294,6.721-7.437v-27.22C246.988,85.63,241.245,75.351,232.034,69.513z"
                            />
                            <path
                              d="M149.763,201.464c3.01-3.811,4.871-8.615,4.871-13.836c0-12.337-10.006-22.373-22.343-22.373s-22.358,10.036-22.358,22.373
		...
		c9.872,0,17.999,8.032,17.999,17.906V248.976z"
                            />
                            <path
                              d="M138.988,138.555v-24.854c0-4.143-3.357-7.5-7.5-7.5c-4.143,0-7.5,3.357-7.5,7.5v24.854c0,4.143,3.357,7.5,7.5,7.5
		C135.63,146.055,138.988,142.697,138.988,138.555z"
                            />
                            <path
                              d="M59.331,140.177c-3.009-2.847-7.753-2.718-10.604,0.289c-2.848,3.008-2.718,7.755,0.289,10.604l37.709,35.707
		c1.451,1.373,3.305,2.054,5.156,2.054c1.987,0,3.972-0.786,5.447-2.343c2.848-3.008,2.718-7.755-0.289-10.604L59.331,140.177z"
                            />
                            <path
                              d="M205.241,140.071l-37.606,35.789c-3.001,2.855-3.118,7.603-0.263,10.603c1.474,1.55,3.452,2.33,5.434,2.33
		...
		C212.989,137.332,208.241,137.217,205.241,140.071z"
                      ...
                      <p className="text-gray-500">
                        Connect and actively engage with fellow
                        enthusiasts—post, comment, like, and share valuable
                        insights in our interactive aquarium forum
                      </p>
                    </div>
                    {/* End service block */}
                  </div>
                      ...
                      <div className="inline-block mb-4 text-gray-900">
                        ...
                        >
                          <g>
                            <g>
                              <path
                                d="M9.743,22.4c-0.477-0.201-1.675-3.75-1.807-4.158c0.381,0.229,1.287,0.591,1.729,0.402
			...
			c0.413,0.16,1.534-0.362,1.777-0.43c-0.066,0.42-2.092,4.063-2.092,4.063l3.435-0.885l-0.43,9.255h1.718l-0.43-9.235L9.743,22.4z"
                              />
                              <path
                                d="M28.759,20.259c-1.074-0.453-3.77-6.365-4.066-7.281c0.857,0.515,2.896,1.331,3.893,0.907
			...
			c-0.147,0.943-4.709,7.068-4.71,7.068l7.732-1.993l-0.965,12.506h3.867l-0.967-12.465L28.759,20.259z"
                              />
                              <path
                                d="M15.963,23.527c-0.068-0.193,0.068-0.377-0.023-0.548c-0.091-0.172-0.387-0.694-0.794-0.694
			...
			C16.319,24.054,16.032,23.721,15.963,23.527z"
                      ...
                      <h3 className="mb-2 text-lg font-semibold leading-normal text-black">
                        {" "}
                        Environmental Reccomendations
                      </h3>
                      <p className="text-gray-500">
                        Create the perfect habitat with our Environment
                        Recommendation—get tailored advice for your tank setup
                      </p>
                    </div>
                    {/* End service block */}
                  </div>
        ...
        {/* new  Section Start */}
        {/* Feature introduction Section start*/}
        <section className="mt-96">
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                <h2 className="mb-6 text-5xl font-bold leading-tight text-white Polysans_median">
                  Fish Search
                </h2>
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Here are slightly expanded introductions for your features:
                  Fish Search Easily explore a wide range of fish species with
                  our Fish Search feature. Get detailed information and
                  advertisement suggestions to help you find the perfect fish
                  for your aquarium setup.
                </p>
                <NavLink
                  to="/search"
                  className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1"
                >
                  Explore Fish Search{" "}
              ...
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img
                  src={fishSearchimg}
                  alt="Fish Search"
                  className="w-3/4 max-w-md transition duration-500 ease-in-out transform shadow-2xl rounded-3xl hover:scale-110"
                />
              </div>
            </section>
          </div>
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Receive instant, expert advice on aquarium care through our
                  interactive chatbot. Whether you're a beginner or an expert,
                  get answers to all your queries and ensure the health of your
                  aquatic pets.
                </p>
              </div>
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
          ...
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Promote your aquarium-related products or services with our
                  sleek advertising platform. Reach a passionate audience of
                  aquarium enthusiasts and ensure your offerings stand out with
                  high-quality, aesthetic presentations.
                </p>
                <NavLink
                  to={"/advertisements/products"}
                  className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1"
                >
                  Explore Advertising Platform{" "}
                  <span className="ml-2 text-3xl">&rarr;</span>
                </NavLink>
              </div>
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img
                  src={advertisingPlatformimg}
          ...
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Our Fish Compatibility Tool helps you assess which species can
                  live together harmoniously. Whether pairing or grouping,
                  ensure a peaceful and thriving aquatic environment with just a
                  few clicks.
                </p>
                <NavLink
                  ...
                  className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1"
                >
                  Explore Fish Compatibility Tool{" "}
                  <span className="ml-2 text-3xl">&rarr;</span>
                </NavLink>
              </div>
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img
                  src={fishCompatibilityToolimg}
                  alt="Compatibility Tool"
                  className="w-3/4 max-w-md transition duration-500 ease-in-out transform shadow-2xl rounded-3xl hover:scale-110"
                />
              </div>
            </section>
          ...
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Engage with fellow aquarium enthusiasts in our dynamic forum.
                  Share your experiences, ask questions, and connect with people
                  who share your passion for aquatics.
                </p>
                <NavLink
                  to={"/forum"}
                  className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1"
                >
                  Explore Forum <span className="ml-2 text-3xl">&rarr;</span>
                </NavLink>
              </div>
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img
                  src={communityForumimg}
                  alt="Community Forum"
                  className="w-3/4 max-w-md transition duration-500 ease-in-out transform shadow-2xl rounded-3xl hover:scale-110"
                />
              </div>
          ...
          <div className="container">
            <section className="flex flex-col items-center justify-between p-8 mt-5 shadow-2xl bg-gradient-to-r from-blue-500 to-teal-400 rounded-3xl md:flex-row lg:py-20">
              <div className="text-center md:w-1/2 md:text-left">
                ...
                <p className="mb-6 text-lg text-white Polysans_slim">
                  Get personalized advice for your aquarium’s environment with
                  our tailored recommendations. From water conditions to tank
                  setup, ensure your fish have the ideal habitat for a healthy
                  life.
                </p>
                <NavLink
                  to={"/compatibility/compatibility-tool"}
                  className="inline-flex items-center px-6 py-3 text-xl font-semibold text-blue-600 transition-transform transform bg-white rounded-full shadow-lg hover:bg-blue-100 hover:-translate-y-1"
                >
                  Explore <span className="ml-2 text-3xl">&rarr;</span>
                </NavLink>
              </div>
              <div className="flex justify-center mt-10 md:w-1/2 md:mt-0">
                <img
                  src={environmentalRecommendationsimg}
                  alt="Environmental Recommendations"
                  className="w-3/4 max-w-md transition duration-500 ease-in-out transform shadow-2xl rounded-3xl hover:scale-110"
                />
              </div>
            </section>
        ...
        {/* Feature introduction Section end*/}
        {/* new  Section End */}
        ...
        <section className="ml-4 ">
          <footer className="relative w-full ">
            <div className="w-full px-8 mx-auto max-w-7xl">
              <div className="grid w-full grid-cols-1 gap-8 py-12 mx-auto md:grid-cols-3">
                {SITEMAP.map(({ title, links }, key) => (
                  <div key={key} className="w-full">
                    <Typography
                      variant="small"
                      color="blue-gray"
                      className="mb-4 text-xl font-bold text-white uppercase opacity-70"
                    >
                      {title}
                    </Typography>
              ...
              <div className="flex flex-col items-center justify-center w-full py-4 border-t border-blue-gray-50 md:flex-row md:justify-between">
                ...
                >
                  &copy; {currentYear}{" "}
                  <a href="https://material-tailwind.com/">Happy Tank</a>. All
                  Rights Reserved.
                </Typography>
                <div className="flex gap-4 text-white sm:justify-center">
                  ...
                  >
                    <svg
                      ...
                      aria-hidden="true"
                    >
                      <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743A11.651 11.651 0 013.15 4.576a4.106 4.106 0 001.27 5.482 4.073 4.073 0 01-1.861-.514v.052a4.107 4.107 0 003.292 4.027 4.09 4.09 0 01-1.853.07 4.108 4.108 0 003.834 2.85 8.233 8.233 0 01-5.096 1.757A8.42 8.42 0 012 18.407 11.616 11.616 0 008.29 20.25z" />
                    </svg>
                  </Typography>
                </div>
              </div>
